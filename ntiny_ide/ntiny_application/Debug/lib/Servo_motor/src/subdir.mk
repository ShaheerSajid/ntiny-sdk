...
C_SRCS += \
../lib/Servo_motor/src/servo.c 

OBJS += \
./lib/Servo_motor/src/servo.o 

C_DEPS += \
./lib/Servo_motor/src/servo.d 


# Each subdirectory must supply rules for building sources it contributes
lib/Servo_motor/src/%.o: ../lib/Servo_motor/src/%.c lib/Servo_motor/src/subdir.mk
	@echo 'Building file: $<'
