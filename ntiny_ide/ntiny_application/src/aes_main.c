...
int main(void) {
	...
	ee_printf("\nTesting AES128\n\n");
#else
    ee_printf("You need to specify a symbol between AES128, AES192 or AES256. Exiting");
    return 0;
#endif
...
static void test_encrypt_ecb_verbose(void) {
	...
	ee_printf("ECB encrypt verbose:\n\n");
	ee_printf("plain text:\n");
	...
	for (i = 0; i < 4; ++i) {
		...
		clock_t t2 = clock();
		//float sec = ((float) t2 - (float) t1) / 50000000.0;
